...
<html>
    ...
    <body>
		...
		?>-->
		<!-- <form action=
		"<?php //echo base_url('admin/maintenance'); ?>"
		...
		<div class="table-responsive">
			<table class="table table-bordered" cellspacing="0">
					<tr>
						...
						<th width="900px" class="text-center">Isi</th>
					...
					<tr>
						...
						<td width="800px" class="align-middle"><?php echo $i['Isi'] ?></td>
		...
		<center> </center>
		<div class="table-responsive">
			<table class="table table-bordered" width="1000px" cellspacing="0">
					<tr>
						<th class="text-center">No</th>
						<th class="text-center">ID Informasi</th>
						<th class="text-center">ID Admin</th>
						...
						<th class="text-center">Tipe</th>
						<th class="text-center">Gambar</th>
						<th width="800px"class="text-center">Isi</th>
						<th class="text-center">Status</th>
						<th class="text-center">Tanggal Terbit</th>
						<th class="text-center">Jam Terbit</th>
						<th colspan="4" class="text-center"><span class="glyphicon glyphicon-cog"> Opsi</span></th>
